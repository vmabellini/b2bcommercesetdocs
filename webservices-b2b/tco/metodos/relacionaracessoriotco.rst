Relacionar Acessorio TCO
========================

Relaciona um acessório a impressora TCO
...
.. code-block:: xml
  ...
  <s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
    <s:Body>
      <RelacionarAcessorioTcoResponse xmlns="http://tempuri.org/">
        <RelacionarAcessorioTcoResult xmlns:a="http://schemas.datacontract.org/2004/07/B2B.Integration.Webservices" xmlns:i="http://www.w3.org/2001/XMLSchema-instance">
          <a:Error>false</a:Error>
          <a:ErrorType i:nil="true"/>
          <a:Message i:nil="true"/>
        </RelacionarAcessorioTcoResult>
      </RelacionarAcessorioTcoResponse>
    </s:Body>
  </s:Envelope>